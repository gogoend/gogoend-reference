...
function shiftDownRobbyContainer() {
  setRobbyJumpDownAndFallFrame(),
    $(robbyContainerDiv)
      .stop()
      .animate({ bottom: "20%" }, 500, function () {
...
function shiftRobbyToSeaFloor() {
  $(robbyContainerDiv)
    .stop()
    .animate({ bottom: seaFloorDiv.offsetHeight + "px" }, 300, function () {});
}
...
function robbySwimDown(e) {
  $(robbyContainerDiv)
    .stop()
    .animate({ bottom: seaFloorDiv.offsetHeight + "px" }, e, function () {
      setRobbyStaticFrame();
    }),
...
function nbaBoardsJump() {
  for (var e = 0; e < nbaBoardArray.length; e++)
    $(nbaBoardArray[e])
      .stop()
      .delay(100 * e)
      .animate({ bottom: [200, "easeOutCubic"] }, 300, function () {
        nbaBoardsFall();
      });
}
function nbaBoardsFall() {
  $(nbaBoardArray[nbaBoardsCounter])
    .stop()
    .animate({ bottom: [0, "easeInCubic"] }, 300, function () {}),
...
function nbaPlayerRun() {
  clearInterval(nbaPlayerTimer),
    ...
    $(nbaPlayerContainerDiv)
      .stop()
      .animate({ left: "690px" }, 1e3, function () {
        nbaPlayerJump();
      });
}
...
function shakeRim() {
  $(nbaRimContainerDiv)
    .stop()
    .animate({ bottom: [-50, "easeOutCubic"] }, 100, function () {
      moveRimUp();
    });
}
function moveRimUp() {
  $(nbaRimContainerDiv)
    .stop()
    .animate({ bottom: [0, "easeOutElastic"] }, 500, function () {});
}
function bounceBall() {
  (nbaBallDiv.style.opacity = "1"),
    $(nbaBallDiv)
      .stop()
      .animate({ bottom: [0, "easeOutBounce"] }, 1200, function () {});
}
...
function animateRobot() {
  $(robotDiv)
    .stop()
    .animate({ left: "420px" }, 1e3, function () {
...
function animateSquid() {
  $(squidDiv)
    .stop()
    .animate({ left: "430px" }, 1e3, function () {
...
function animateAlien() {
  $(alienDiv)
    .stop()
    .animate({ left: "450px" }, 1e3, function () {
...
function animateSocialContainer() {
  1 == canAnimateSocialContainer &&
    ($(socialContainerDiv)
      .stop()
      .animate({ top: [0, "easeOutCubic"] }, 1e3, function () {}),
